...
export function RegisterPage() {
    ...
    try {
      ...
      const message =
        caught instanceof AxiosError
          ? caught.response?.data?.message ?? 'Unable to create account.'
  ...
  return (
    <AuthLayout
      ...
      subtitle="Register a secure Dochat account and start testing the mock backend instantly."
    >
      ...
      <p className="mt-6 text-center text-sm text-zinc-500">
        ...
        <Link to="/login" className="font-medium text-zinc-100 hover:text-indigo-300">
          Sign in
        </Link>
      </p>
    </AuthLayout>
